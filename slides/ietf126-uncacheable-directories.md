...
<!-- Slide role: CONTENT
     ...
     make.  Authors' recommendation: a 2nd WGLC opens ~1-2 weeks
     after IETF 126, on -08.  A focused re-review of the -07 -> -08
     delta is a lighter alternative.  Aim is WGLC re-closes this
     cycle so publication can be requested. -->
# What we're asking for procedurally

**WGLC comments addressed in -08** (see slide 3).

- **Preferred:** 2nd WGLC opens ~1&ndash;2 weeks after IETF 126, on -08
- **Alternate:** focused re-review of the -07 &rarr; -08 delta
